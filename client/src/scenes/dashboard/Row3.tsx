      ...
      <DashboardBox gridArea="j">
        ...
        >
          ...
          <Typography margin="0 1rem" variant="h6">
            This is a sample text area that is meant to be filled in or used. An overall summary or explanation of the data should be included here. Hope you enjoy the project!
          </Typography>
        </Box>
      </DashboardBox>
    </>
